...
int F_generic(const T** arg, T** res) {
	...
	OpenSim::Body* torso;
	torso = new OpenSim::Body("torso", 24.34090143498402980526, Vec3(-0.02676026676359908804, 0.30650513962530268053, 0.00000000000000000000), Inertia(1.33787580855881671482, 0.68549689614526010395, 1.29876936749480509370, 0., 0., 0.));
	model->addBody(torso);
