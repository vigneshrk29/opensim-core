...
int F_generic(const T** arg, T** res) {
    ...
    Vec3 locSphere_front_l = Vec3(0.025, -0.01, 0);
    Vec3 locSphere_heel_r = Vec3(0.01, 0, 0);
    Vec3 locSphere_front_r = Vec3(0.025, -0.01, 0);
    ...
    /// Calculate torques
    /// sphere heel_l
    Vec3 pos_InGround_heel_l = calcn_l->findStationLocationInGround(*state, locSphere_heel_l);
    ...
    /// sphere heel_r
    Vec3 pos_InGround_heel_r = calcn_r->findStationLocationInGround(*state, locSphere_heel_r);
    ...
    /// sphere front_l
    Vec3 pos_InGround_front_l = toes_l->findStationLocationInGround(*state, locSphere_front_l);
    ...
    Vec3 contactPointPos_InBody_front_l = model->getGround().findStationLocationInAnotherFrame(*state, contactPointpos_InGround_front_l_adj, *toes_l);
     /// sphere front_r
    Vec3 pos_InGround_front_r = toes_r->findStationLocationInGround(*state, locSphere_front_r);
