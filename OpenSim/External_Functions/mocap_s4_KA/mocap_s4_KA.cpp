...
int F_generic(const T** arg, T** res) {
	...
	Vec3 SmoothSphereHalfSpaceForce_s1_r_location(-0.00053421782381878763, -0.01000000000000000021, -0.00633325419716085965);
	...
	Vec3 SmoothSphereHalfSpaceForce_s2_r_location(0.07604163368079155938, -0.01000000000000000021, 0.02534847858749186833);
	...
	Vec3 SmoothSphereHalfSpaceForce_s3_r_location(0.20911449262217679523, -0.01000000000000000021, 0.02684649877100345888);
	...
	Vec3 SmoothSphereHalfSpaceForce_s4_r_location(0.20911449262217679523, -0.01000000000000000021, -0.01267360561346526047);
	...
	Vec3 SmoothSphereHalfSpaceForce_s5_r_location(0.06736528327781324266, -0.01000000000000000021, -0.00433095124628948315);
	...
	Vec3 SmoothSphereHalfSpaceForce_s6_r_location(0.00000220279939167640, -0.01000000000000000021, 0.02825453635465945135);
	...
	Vec3 SmoothSphereHalfSpaceForce_s1_l_location(-0.00053421782381878763, -0.01000000000000000021, 0.00633325419716085965);
	...
	Vec3 SmoothSphereHalfSpaceForce_s2_l_location(0.07604163368079155938, -0.01000000000000000021, -0.02534847858749186833);
	...
	Vec3 SmoothSphereHalfSpaceForce_s3_l_location(0.20911449262217679523, -0.01000000000000000021, -0.02684649877100345888);
	...
	Vec3 SmoothSphereHalfSpaceForce_s4_l_location(0.20911449262217679523, -0.01000000000000000021, 0.01267360561346526047);
	...
	Vec3 SmoothSphereHalfSpaceForce_s5_l_location(0.06736528327781324266, -0.01000000000000000021, 0.00433095124628948315);
	...
	Vec3 SmoothSphereHalfSpaceForce_s6_l_location(0.00000220279939167640, -0.01000000000000000021, -0.02825453635465945135);
