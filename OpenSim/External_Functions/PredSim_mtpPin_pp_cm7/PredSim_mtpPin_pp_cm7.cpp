...
int F_generic(const T** arg, T** res) {
    ...
    /// Contact elements
    /// Parameters
    osim_double_adouble radiusSphere_s1 = 0.032;
    osim_double_adouble radiusSphere_s2 = 0.032;
    osim_double_adouble radiusSphere_s3 = 0.032;
    osim_double_adouble radiusSphere_s4 = 0.032;
    osim_double_adouble radiusSphere_s5 = 0.032;
    osim_double_adouble radiusSphere_s6 = 0.032;
    ...
    Vec3 locSphere_1_r(0.00190115788407966, 0.01, -0.00382630379623308);
    Vec3 locSphere_2_r(0.148386399942063, 0.01, -0.028713422052654);
    Vec3 locSphere_3_r(0.133001170607051, 0.01, 0.0516362473449566);
    Vec3 locSphere_4_r(0.06, 0.01, -0.0187603084619177);
    Vec3 locSphere_5_r(0.0662346661991635, 0.01, 0.0263641606741698);
    Vec3 locSphere_6_r(0.045, 0.01, 0.0618569567549652);
