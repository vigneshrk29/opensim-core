...
int F_generic(const T** arg, T** res) {
    ...
    /// sphere 3 left
    Vec3 pos_InGround_HC_s3_l = toes_l->findStationLocationInGround(*state, locSphere_s3_l);
    ...
    Vec3 contactPointPos_InBody_HC_s3_l = model->getGround().findStationLocationInAnotherFrame(*state, contactPointpos_InGround_HC_s3_l_adj, *toes_l);
    /// sphere 4 left
    ...
    /// sphere 3 right
    Vec3 pos_InGround_HC_s3_r = toes_r->findStationLocationInGround(*state, locSphere_s3_r);
    ...
    Vec3 contactPointPos_InBody_HC_s3_r = model->getGround().findStationLocationInAnotherFrame(*state, contactPointpos_InGround_HC_s3_r_adj, *toes_r);
    /// sphere 4 right
    ...
    model->getMatterSubsystem().addInStationForce(*state, toes_l->getMobilizedBodyIndex(), contactPointPos_InBody_HC_s3_l, AppliedPointForce_s3_l, appliedBodyForces);
    ...
    model->getMatterSubsystem().addInStationForce(*state, toes_r->getMobilizedBodyIndex(), contactPointPos_InBody_HC_s3_r, AppliedPointForce_s3_r, appliedBodyForces);
    ...
    AppliedPointTorque_s3_l = (TR_GB_toes_l*contactPointPos_InBody_HC_s3_l) % AppliedPointForce_s3_l;
    ...
    AppliedPointTorque_s3_r = (TR_GB_toes_r*contactPointPos_InBody_HC_s3_r) % AppliedPointForce_s3_r;
