...
int F_generic(const T** arg, T** res) {
    ...
    /// Contact elements
    OpenSim::SmoothSphereHalfSpaceForce* HC_heel_r;
    OpenSim::SmoothSphereHalfSpaceForce* HC_front_r;
    OpenSim::SmoothSphereHalfSpaceForce* HC_heel_l;
    OpenSim::SmoothSphereHalfSpaceForce* HC_front_l;
    ...
    HC_heel_r = new SmoothSphereHalfSpaceForce("sphere_heel_r", *calcn_r, model->getGround());
    HC_heel_r->set_contact_sphere_location(locSphere_heel_r);
    HC_heel_r->set_contact_sphere_radius(radiusSphere_heel);
    HC_heel_r->set_contact_half_space_location(halfSpaceLocation);
    HC_heel_r->set_contact_half_space_orientation(halfSpaceOrientation);
    HC_heel_r->set_stiffness(stiffness_heel);
    ...
    HC_heel_r->connectSocket_sphere_frame(*calcn_r);
    HC_heel_r->connectSocket_half_space_frame(model->getGround());

    HC_front_r = new SmoothSphereHalfSpaceForce("sphere_front_r", *calcn_r, model->getGround());
    HC_front_r->set_contact_sphere_location(locSphere_front_r);
    HC_front_r->set_contact_sphere_radius(radiusSphere_front);
    HC_front_r->set_contact_half_space_location(halfSpaceLocation);
    HC_front_r->set_contact_half_space_orientation(halfSpaceOrientation);
    HC_front_r->set_stiffness(stiffness_front);
    ...
    HC_front_r->connectSocket_sphere_frame(*calcn_r);
    HC_front_r->connectSocket_half_space_frame(model->getGround());
    ...
    HC_heel_l = new SmoothSphereHalfSpaceForce("sphere_heel_l", *calcn_l, model->getGround());
    HC_heel_l->set_contact_sphere_location(locSphere_heel_l);
    HC_heel_l->set_contact_sphere_radius(radiusSphere_heel);
    HC_heel_l->set_contact_half_space_location(halfSpaceLocation);
    HC_heel_l->set_contact_half_space_orientation(halfSpaceOrientation);
    HC_heel_l->set_stiffness(stiffness_heel);
    ...
    HC_heel_l->connectSocket_sphere_frame(*calcn_l);
    HC_heel_l->connectSocket_half_space_frame(model->getGround());

    HC_front_l = new SmoothSphereHalfSpaceForce("sphere_front_l", *calcn_l, model->getGround());
    HC_front_l->set_contact_sphere_location(locSphere_front_l);
    HC_front_l->set_contact_sphere_radius(radiusSphere_front);
    HC_front_l->set_contact_half_space_location(halfSpaceLocation);
    HC_front_l->set_contact_half_space_orientation(halfSpaceOrientation);
    HC_front_l->set_stiffness(stiffness_front);
    ...
    HC_front_l->connectSocket_sphere_frame(*calcn_l);
    HC_front_l->connectSocket_half_space_frame(model->getGround());
