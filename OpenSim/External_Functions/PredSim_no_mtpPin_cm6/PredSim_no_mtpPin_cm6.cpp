...
int F_generic(const T** arg, T** res) {
    ...
    osim_double_adouble radiusSphere_s2 = 0.016;
    osim_double_adouble radiusSphere_s3 = 0.016;
    osim_double_adouble radiusSphere_s4 = 0.016;
    osim_double_adouble radiusSphere_s5 = 0.032;
    osim_double_adouble radiusSphere_s6 = 0.016;
