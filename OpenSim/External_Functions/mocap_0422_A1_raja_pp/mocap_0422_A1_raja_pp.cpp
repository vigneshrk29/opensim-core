...
int F_generic(const T** arg, T** res) {
	...
	OpenSim::Body* pelvis;
	pelvis = new OpenSim::Body("pelvis", 13.00617757542774555191, Vec3(-0.07428303068803732145, 0.00000000000000000000, 0.00000000000000000000), Inertia(0.11352934149222827787, 0.09619071638106110878, 0.06394308241634258372, 0., 0., 0.));
	model->addBody(pelvis);

	OpenSim::Body* femur_r;
	femur_r = new OpenSim::Body("femur_r", 10.27219666299427913714, Vec3(0.00000000000000000000, -0.18286830199445863743, 0.00000000000000000000), Inertia(0.17110968942721568875, 0.04485399625761965492, 0.18043829833549557273, 0., 0., 0.));
	model->addBody(femur_r);

	OpenSim::Body* tibia_r;
	tibia_r = new OpenSim::Body("tibia_r", 4.09445557959568429141, Vec3(0.00000000000000000000, -0.21821547089396375885, 0.00000000000000000000), Inertia(0.07603752635902803758, 0.00769427350061593213, 0.07709360311401454446, 0., 0., 0.));
	model->addBody(tibia_r);

	OpenSim::Body* talus_r;
	talus_r = new OpenSim::Body("talus_r", 0.11043710261889910784, Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), Inertia(0.00148036646505494041, 0.00148036646505494041, 0.00148036646505494041, 0., 0., 0.));
	model->addBody(talus_r);

	OpenSim::Body* calcn_r;
	calcn_r = new OpenSim::Body("calcn_r", 1.38046378273623870925, Vec3(0.11577828632293485356, 0.03473348589688045329, 0.00000000000000000000), Inertia(0.00207251305107691635, 0.00577342921371426683, 0.00606950250672525556, 0., 0., 0.));
	model->addBody(calcn_r);

	OpenSim::Body* toes_r;
	toes_r = new OpenSim::Body("toes_r", 0.23920676427253542706, Vec3(0.04005928706773545511, 0.00694669717937609118, -0.02026120010651360007), Inertia(0.00014803664650549404, 0.00029607329301098808, 0.00148036646505494041, 0., 0., 0.));
	model->addBody(toes_r);

	OpenSim::Body* femur_l;
	femur_l = new OpenSim::Body("femur_l", 10.27219666299427913714, Vec3(0.00000000000000000000, -0.18286830199445863743, 0.00000000000000000000), Inertia(0.17110968942721568875, 0.04485399625761965492, 0.18043829833549557273, 0., 0., 0.));
	model->addBody(femur_l);

	OpenSim::Body* tibia_l;
	tibia_l = new OpenSim::Body("tibia_l", 4.09445557959568429141, Vec3(0.00000000000000000000, -0.21821547089396375885, 0.00000000000000000000), Inertia(0.07603752635902803758, 0.00769427350061593213, 0.07709360311401454446, 0., 0., 0.));
	model->addBody(tibia_l);

	OpenSim::Body* talus_l;
	talus_l = new OpenSim::Body("talus_l", 0.11043710261889910784, Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), Inertia(0.00148036646505494041, 0.00148036646505494041, 0.00148036646505494041, 0., 0., 0.));
	model->addBody(talus_l);

	OpenSim::Body* calcn_l;
	calcn_l = new OpenSim::Body("calcn_l", 1.38046378273623870925, Vec3(0.11577828632293485356, 0.03473348589688045329, 0.00000000000000000000), Inertia(0.00207251305107691635, 0.00577342921371426683, 0.00606950250672525556, 0., 0., 0.));
	model->addBody(calcn_l);

	OpenSim::Body* toes_l;
	toes_l = new OpenSim::Body("toes_l", 0.23920676427253542706, Vec3(0.04005928706773545511, 0.00694669717937609118, 0.02026120010651360007), Inertia(0.00014803664650549404, 0.00029607329301098808, 0.00148036646505494041, 0., 0., 0.));
	model->addBody(toes_l);

	OpenSim::Body* torso;
	torso = new OpenSim::Body("torso", 29.62651977116158263925, Vec3(-0.03125929163364612323, 0.33343244409222533298, 0.00000000000000000000), Inertia(1.62839507811566708284, 0.83435231028578260570, 1.58079668688692165368, 0., 0., 0.));
	model->addBody(torso);

	OpenSim::Body* humerus_r;
	humerus_r = new OpenSim::Body("humerus_r", 2.24463411072912455424, Vec3(0.00000000000000000000, -0.17940162386831456920, 0.00000000000000000000), Inertia(0.01569090125206137193, 0.00541287494221872646, 0.01761253096340958599, 0., 0., 0.));
	model->addBody(humerus_r);

	OpenSim::Body* ulna_r;
	ulna_r = new OpenSim::Body("ulna_r", 0.67090539840981200381, Vec3(0.00000000000000000000, -0.13804218925651398631, 0.00000000000000000000), Inertia(0.00429110809363961090, 0.00089530884600583368, 0.00465473676734100977, 0., 0., 0.));
	model->addBody(ulna_r);

	OpenSim::Body* radius_r;
	radius_r = new OpenSim::Body("radius_r", 0.67090539840981200381, Vec3(0.00000000000000000000, -0.13804218925651398631, 0.00000000000000000000), Inertia(0.00429110809363961090, 0.00089530884600583368, 0.00465473676734100977, 0., 0., 0.));
	model->addBody(radius_r);

	OpenSim::Body* hand_r;
	hand_r = new OpenSim::Body("hand_r", 0.50524974448146342532, Vec3(0.00000000000000000000, -0.07799197575127418680, 0.00000000000000000000), Inertia(0.00129225807546473094, 0.00079244973910225084, 0.00194128455282818334, 0., 0., 0.));
	model->addBody(hand_r);

	OpenSim::Body* humerus_l;
	humerus_l = new OpenSim::Body("humerus_l", 2.24463411072912455424, Vec3(0.00000000000000000000, -0.17940162386831456920, 0.00000000000000000000), Inertia(0.01569090125206137193, 0.00541287494221872646, 0.01761253096340958599, 0., 0., 0.));
	model->addBody(humerus_l);

	OpenSim::Body* ulna_l;
	ulna_l = new OpenSim::Body("ulna_l", 0.67090539840981200381, Vec3(0.00000000000000000000, -0.13804218925651398631, 0.00000000000000000000), Inertia(0.00429110809363961090, 0.00089530884600583368, 0.00465473676734100977, 0., 0., 0.));
	model->addBody(ulna_l);

	OpenSim::Body* radius_l;
	radius_l = new OpenSim::Body("radius_l", 0.67090539840981200381, Vec3(0.00000000000000000000, -0.13804218925651398631, 0.00000000000000000000), Inertia(0.00429110809363961090, 0.00089530884600583368, 0.00465473676734100977, 0., 0., 0.));
	model->addBody(radius_l);

	OpenSim::Body* hand_l;
	hand_l = new OpenSim::Body("hand_l", 0.50524974448146342532, Vec3(0.00000000000000000000, -0.07799197575127418680, 0.00000000000000000000), Inertia(0.00129225807546473094, 0.00079244973910225084, 0.00194128455282818334, 0., 0., 0.));
	...
	hip_r = new OpenSim::CustomJoint("hip_r", *pelvis, Vec3(-0.05912803161244679223, -0.08246782289538967525, 0.07786620222650332546), Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), *femur_r, Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), st_hip_r);
	...
	walker_knee_r = new OpenSim::CustomJoint("walker_knee_r", *femur_r, Vec3(-0.00870237978314805996, -0.43884089695093730921, -0.00295816370873388948), Vec3(-1.64156999999999997364, 1.44618000000000002103, 1.57079999999999997407), *tibia_r, Vec3(-0.00945507648856751606, -0.00413148391277976933, -0.00173536817490682225), Vec3(-1.64156999999999997364, 1.44618000000000002103, 1.57079999999999997407), st_walker_knee_r);

	OpenSim::PinJoint* ankle_r;
	ankle_r = new OpenSim::PinJoint("ankle_r", *tibia_r, Vec3(-0.01168802736443298046, -0.46752109457731921838, 0.00000000000000000000), Vec3(0.17589499999999999580, -0.10520799999999999597, 0.01866220000000000032), *talus_r, Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), Vec3(0.17589499999999999580, -0.10520799999999999597, 0.01866220000000000032));

	OpenSim::PinJoint* subtalar_r;
	subtalar_r = new OpenSim::PinJoint("subtalar_r", *talus_r, Vec3(-0.05646507023969533218, -0.04856899111247117012, 0.00916964027677644004), Vec3(-1.76818999999999992845, 0.90622300000000000075, 1.81960000000000010623), *calcn_r, Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), Vec3(-1.76818999999999992845, 0.90622300000000000075, 1.81960000000000010623));

	OpenSim::WeldJoint* mtp_r;
	mtp_r = new OpenSim::WeldJoint("mtp_r", *calcn_r, Vec3(0.20701157594540750551, -0.00231556572645869692, 0.00125040549228769651), Vec3(-3.14158999999999988262, 0.61990100000000003533, 0.00000000000000000000), *toes_r, Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), Vec3(-3.14158999999999988262, 0.61990100000000003533, 0.00000000000000000000));
	...
	hip_l = new OpenSim::CustomJoint("hip_l", *pelvis, Vec3(-0.05912803161244679223, -0.08246782289538967525, -0.07786620222650332546), Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), *femur_l, Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), st_hip_l);
	...
	walker_knee_l = new OpenSim::CustomJoint("walker_knee_l", *femur_l, Vec3(-0.00870237978314805996, -0.43884089695093730921, 0.00295816370873388948), Vec3(1.64156999999999997364, -1.44618000000000002103, 1.57079999999999997407), *tibia_l, Vec3(-0.00945507648856751606, -0.00413148391277976933, 0.00173536817490682225), Vec3(1.64156999999999997364, -1.44618000000000002103, 1.57079999999999997407), st_walker_knee_l);

	OpenSim::PinJoint* ankle_l;
	ankle_l = new OpenSim::PinJoint("ankle_l", *tibia_l, Vec3(-0.01168802736443298046, -0.46752109457731921838, 0.00000000000000000000), Vec3(-0.17589499999999999580, 0.10520799999999999597, 0.01866220000000000032), *talus_l, Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), Vec3(-0.17589499999999999580, 0.10520799999999999597, 0.01866220000000000032));

	OpenSim::PinJoint* subtalar_l;
	subtalar_l = new OpenSim::PinJoint("subtalar_l", *talus_l, Vec3(-0.05646507023969533218, -0.04856899111247117012, -0.00916964027677644004), Vec3(1.76818999999999992845, -0.90622300000000000075, 1.81960000000000010623), *calcn_l, Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), Vec3(1.76818999999999992845, -0.90622300000000000075, 1.81960000000000010623));

	OpenSim::WeldJoint* mtp_l;
	mtp_l = new OpenSim::WeldJoint("mtp_l", *calcn_l, Vec3(0.20701157594540750551, -0.00231556572645869692, -0.00125040549228769651), Vec3(-3.14158999999999988262, -0.61990100000000003533, 0.00000000000000000000), *toes_l, Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), Vec3(-3.14158999999999988262, -0.61990100000000003533, 0.00000000000000000000));
	...
	acromial_r = new OpenSim::CustomJoint("acromial_r", *torso, Vec3(0.00328743550347178424, 0.38709422806331789113, 0.22677964232860256533), Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), *humerus_r, Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), st_acromial_r);

	OpenSim::PinJoint* elbow_r;
	elbow_r = new OpenSim::PinJoint("elbow_r", *humerus_r, Vec3(0.01433450623168792092, -0.31220192502008492497, -0.01046405868023779669), Vec3(-0.02286269999999999969, 0.22801799999999999846, 0.00516889999999999971), *ulna_r, Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), Vec3(-0.02286269999999999969, 0.22801799999999999846, 0.00516889999999999971));

	OpenSim::PinJoint* radioulnar_r;
	radioulnar_r = new OpenSim::PinJoint("radioulnar_r", *ulna_r, Vec3(-0.00770470696642663096, -0.01489744663480172156, 0.02987392177869864496), Vec3(-1.56884000000000001229, 0.05642799999999999899, 1.53614000000000006096), *radius_r, Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), Vec3(-1.56884000000000001229, 0.05642799999999999899, 1.53614000000000006096));

	OpenSim::WeldJoint* radius_hand_r;
	radius_hand_r = new OpenSim::WeldJoint("radius_hand_r", *radius_r, Vec3(-0.01007556223928275131, -0.27011829874669585072, 0.01558808708385111402), Vec3(-1.57079999999999997407, 0.00000000000000000000, -1.57079999999999997407), *hand_r, Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), Vec3(-1.57079999999999997407, 0.00000000000000000000, -1.57079999999999997407));
	...
	acromial_l = new OpenSim::CustomJoint("acromial_l", *torso, Vec3(0.00328743550347178424, 0.38709422806331789113, -0.22677964232860256533), Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), *humerus_l, Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), st_acromial_l);

	OpenSim::PinJoint* elbow_l;
	elbow_l = new OpenSim::PinJoint("elbow_l", *humerus_l, Vec3(0.01433450623168792092, -0.31220192502008492497, 0.01046405868023779669), Vec3(0.02286269999999999969, -0.22801799999999999846, 0.00516889999999999971), *ulna_l, Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), Vec3(0.02286269999999999969, -0.22801799999999999846, 0.00516889999999999971));

	OpenSim::PinJoint* radioulnar_l;
	radioulnar_l = new OpenSim::PinJoint("radioulnar_l", *ulna_l, Vec3(-0.00770470696642663096, -0.01489744663480172156, -0.02987392177869864496), Vec3(1.56884000000000001229, -0.05642799999999999899, 1.53614000000000006096), *radius_l, Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), Vec3(1.56884000000000001229, -0.05642799999999999899, 1.53614000000000006096));

	OpenSim::WeldJoint* radius_hand_l;
	radius_hand_l = new OpenSim::WeldJoint("radius_hand_l", *radius_l, Vec3(-0.01007556223928275131, -0.27011829874669585072, -0.01558808708385111402), Vec3(1.57079999999999997407, 0.00000000000000000000, 1.57079999999999997407), *hand_l, Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), Vec3(1.57079999999999997407, 0.00000000000000000000, 1.57079999999999997407));
	...
	Vec3 SmoothSphereHalfSpaceForce_s1_r_location(-0.00053399257761962157, -0.01000000000000000021, -0.00633058386050667360);
	...
	Vec3 SmoothSphereHalfSpaceForce_s2_r_location(0.07600957168622436699, -0.01000000000000000021, 0.02533779072160289442);
	...
	Vec3 SmoothSphereHalfSpaceForce_s3_r_location(0.20902632213711702658, -0.01000000000000000021, 0.02683517928382151210);
	...
	Vec3 SmoothSphereHalfSpaceForce_s4_r_location(0.20902632213711702658, -0.01000000000000000021, -0.01266826194770406117);
	...
	Vec3 SmoothSphereHalfSpaceForce_s5_r_location(0.06733687955682617077, -0.01000000000000000021, -0.00432912515538890885);
	...
	Vec3 SmoothSphereHalfSpaceForce_s6_r_location(0.00000220187060913044, -0.01000000000000000021, 0.02824262318621143658);
	...
	Vec3 SmoothSphereHalfSpaceForce_s1_l_location(-0.00053399257761962157, -0.01000000000000000021, 0.00633058386050667360);
	...
	Vec3 SmoothSphereHalfSpaceForce_s2_l_location(0.07600957168622436699, -0.01000000000000000021, -0.02533779072160289442);
	...
	Vec3 SmoothSphereHalfSpaceForce_s3_l_location(0.20902632213711702658, -0.01000000000000000021, -0.02683517928382151210);
	...
	Vec3 SmoothSphereHalfSpaceForce_s4_l_location(0.20902632213711702658, -0.01000000000000000021, 0.01266826194770406117);
	...
	Vec3 SmoothSphereHalfSpaceForce_s5_l_location(0.06733687955682617077, -0.01000000000000000021, 0.00432912515538890885);
	...
	Vec3 SmoothSphereHalfSpaceForce_s6_l_location(0.00000220187060913044, -0.01000000000000000021, -0.02824262318621143658);
