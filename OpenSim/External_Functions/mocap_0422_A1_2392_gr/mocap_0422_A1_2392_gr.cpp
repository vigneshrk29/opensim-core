...
int F_generic(const T** arg, T** res) {
	...
	OpenSim::Body* pelvis;
	pelvis = new OpenSim::Body("pelvis", 13.03600897230877464494, Vec3(-0.07428303068803732145, 0.00000000000000000000, 0.00000000000000000000), Inertia(0.11378973612578265062, 0.09641134257349871783, 0.06408974437434644678, 0., 0., 0.));
	model->addBody(pelvis);

	OpenSim::Body* femur_r;
	femur_r = new OpenSim::Body("femur_r", 10.29575731128749538357, Vec3(0.00000000000000000000, -0.18669557657871599377, 0.00000000000000000000), Inertia(0.17875605697593505150, 0.04685838386747812750, 0.18850153282301743141, 0., 0., 0.));
	model->addBody(femur_r);

	OpenSim::Body* tibia_r;
	tibia_r = new OpenSim::Body("tibia_r", 4.10384675764921347252, Vec3(0.00000000000000000000, -0.20995724108387406326, 0.00000000000000000000), Inertia(0.07055269225831059532, 0.00713926052613857165, 0.07153259076189824595, 0., 0., 0.));
	model->addBody(tibia_r);

	OpenSim::Body* talus_r;
	talus_r = new OpenSim::Body("talus_r", 0.11069040479161736112, Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), Inertia(0.00148308290106652775, 0.00148308290106652775, 0.00148308290106652775, 0., 0., 0.));
	model->addBody(talus_r);

	OpenSim::Body* calcn_r;
	calcn_r = new OpenSim::Body("calcn_r", 1.38363005989521692385, Vec3(0.11575179275978397797, 0.03472553782793519339, 0.00000000000000000000), Inertia(0.00207631606149313863, 0.00578402331415945724, 0.00608063989437276388, 0., 0., 0.));
	model->addBody(calcn_r);

	OpenSim::Body* toes_r;
	toes_r = new OpenSim::Body("toes_r", 0.23975541677864317669, Vec3(0.04005012029488525666, 0.00694510756558703885, -0.02025656373296219961), Inertia(0.00014830829010665277, 0.00029661658021330555, 0.00148308290106652775, 0., 0., 0.));
	model->addBody(toes_r);

	OpenSim::Body* femur_l;
	femur_l = new OpenSim::Body("femur_l", 10.29575731128749538357, Vec3(0.00000000000000000000, -0.18669557657871599377, 0.00000000000000000000), Inertia(0.17875605697593505150, 0.04685838386747812750, 0.18850153282301743141, 0., 0., 0.));
	model->addBody(femur_l);

	OpenSim::Body* tibia_l;
	tibia_l = new OpenSim::Body("tibia_l", 4.10384675764921347252, Vec3(0.00000000000000000000, -0.20995724108387406326, 0.00000000000000000000), Inertia(0.07055269225831059532, 0.00713926052613857165, 0.07153259076189824595, 0., 0., 0.));
	model->addBody(tibia_l);

	OpenSim::Body* talus_l;
	talus_l = new OpenSim::Body("talus_l", 0.11069040479161736112, Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), Inertia(0.00148308290106652775, 0.00148308290106652775, 0.00148308290106652775, 0., 0., 0.));
	model->addBody(talus_l);

	OpenSim::Body* calcn_l;
	calcn_l = new OpenSim::Body("calcn_l", 1.38363005989521692385, Vec3(0.11575179275978397797, 0.03472553782793519339, 0.00000000000000000000), Inertia(0.00207631606149313863, 0.00578402331415945724, 0.00608063989437276388, 0., 0., 0.));
	model->addBody(calcn_l);

	OpenSim::Body* toes_l;
	toes_l = new OpenSim::Body("toes_l", 0.23975541677864317669, Vec3(0.04005012029488525666, 0.00694510756558703885, 0.02025656373296219961), Inertia(0.00014830829010665277, 0.00029661658021330555, 0.00148308290106652775, 0., 0., 0.));
	model->addBody(toes_l);

	OpenSim::Body* torso;
	torso = new OpenSim::Body("torso", 29.69447213182802158826, Vec3(-0.03125929163364611629, 0.33343244409222527747, 0.00000000000000000000), Inertia(1.63213001865239792920, 0.83626600820066909758, 1.58442245418721094907, 0., 0., 0.));
	model->addBody(torso);

	OpenSim::Body* humerus_r;
	humerus_r = new OpenSim::Body("humerus_r", 2.24978247738962311431, Vec3(0.00000000000000000000, -0.17940162386831459695, 0.00000000000000000000), Inertia(0.01572689041951328207, 0.00542529009030756973, 0.01765292764400247863, 0., 0., 0.));
	model->addBody(humerus_r);

	OpenSim::Body* ulna_r;
	ulna_r = new OpenSim::Body("ulna_r", 0.67244420910907554134, Vec3(0.00000000000000000000, -0.14063256626217990330, 0.00000000000000000000), Inertia(0.00446388043182200950, 0.00093135655194665835, 0.00484214984046054016, 0., 0., 0.));
	model->addBody(ulna_r);

	OpenSim::Body* radius_r;
	radius_r = new OpenSim::Body("radius_r", 0.67244420910907554134, Vec3(0.00000000000000000000, -0.14063256626217990330, 0.00000000000000000000), Inertia(0.00446388043182200950, 0.00093135655194665835, 0.00484214984046054016, 0., 0., 0.));
	model->addBody(radius_r);

	OpenSim::Body* hand_r;
	hand_r = new OpenSim::Body("hand_r", 0.50640860192164938169, Vec3(0.00000000000000000000, -0.07945550383425133145, 0.00000000000000000000), Inertia(0.00134428809763174656, 0.00082435604193336904, 0.00201944624532123321, 0., 0., 0.));
	model->addBody(hand_r);

	OpenSim::Body* humerus_l;
	humerus_l = new OpenSim::Body("humerus_l", 2.24978247738962311431, Vec3(0.00000000000000000000, -0.17940162386831459695, 0.00000000000000000000), Inertia(0.01572689041951328207, 0.00542529009030756973, 0.01765292764400247863, 0., 0., 0.));
	model->addBody(humerus_l);

	OpenSim::Body* ulna_l;
	ulna_l = new OpenSim::Body("ulna_l", 0.67244420910907554134, Vec3(0.00000000000000000000, -0.14063256626217990330, 0.00000000000000000000), Inertia(0.00446388043182200950, 0.00093135655194665835, 0.00484214984046054016, 0., 0., 0.));
	model->addBody(ulna_l);

	OpenSim::Body* radius_l;
	radius_l = new OpenSim::Body("radius_l", 0.67244420910907554134, Vec3(0.00000000000000000000, -0.14063256626217990330, 0.00000000000000000000), Inertia(0.00446388043182200950, 0.00093135655194665835, 0.00484214984046054016, 0., 0., 0.));
	model->addBody(radius_l);

	OpenSim::Body* hand_l;
	hand_l = new OpenSim::Body("hand_l", 0.50640860192164938169, Vec3(0.00000000000000000000, -0.07945550383425133145, 0.00000000000000000000), Inertia(0.00134428809763174656, 0.00082435604193336904, 0.00201944624532123321, 0., 0., 0.));
	...
	hip_r = new OpenSim::CustomJoint("hip_r", *pelvis, Vec3(-0.07428303068803732145, -0.06944990563619897472, 0.08415516290335268990), Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), *femur_r, Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), st_hip_r);
	...
	knee_r = new OpenSim::CustomJoint("knee_r", *femur_r, Vec3(-0.00494177999999999978, -0.43469395999999999036, 0.00000000000000000000), Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), *tibia_r, Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), st_knee_r);
	...
	ankle_r = new OpenSim::CustomJoint("ankle_r", *tibia_r, Vec3(0.00000000000000000000, -0.48356515086269868942, 0.00000000000000000000), Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), *talus_r, Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), st_ankle_r);
	...
	subtalar_r = new OpenSim::CustomJoint("subtalar_r", *talus_r, Vec3(-0.05645214932894664778, -0.04855787706272938348, 0.00916754198657489076), Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), *calcn_r, Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), st_subtalar_r);

	OpenSim::WeldJoint* mtp_r;
	mtp_r = new OpenSim::WeldJoint("mtp_r", *calcn_r, Vec3(0.20696420545449373263, -0.00231503585519567947, 0.00125011936180566708), Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), *toes_r, Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000));
	...
	hip_l = new OpenSim::CustomJoint("hip_l", *pelvis, Vec3(-0.07428303068803732145, -0.06944990563619897472, -0.08415516290335268990), Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), *femur_l, Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), st_hip_l);
	...
	knee_l = new OpenSim::CustomJoint("knee_l", *femur_l, Vec3(-0.00494177999999999978, -0.43469395999999999036, 0.00000000000000000000), Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), *tibia_l, Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), st_knee_l);
	...
	ankle_l = new OpenSim::CustomJoint("ankle_l", *tibia_l, Vec3(0.00000000000000000000, -0.48356515086269868942, 0.00000000000000000000), Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), *talus_l, Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), st_ankle_l);
	...
	subtalar_l = new OpenSim::CustomJoint("subtalar_l", *talus_l, Vec3(-0.05645214932894664778, -0.04855787706272938348, -0.00916754198657489076), Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), *calcn_l, Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), st_subtalar_l);

	OpenSim::WeldJoint* mtp_l;
	mtp_l = new OpenSim::WeldJoint("mtp_l", *calcn_l, Vec3(0.20696420545449373263, -0.00231503585519567947, -0.00125011936180566708), Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), *toes_l, Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000));
	...
	back = new OpenSim::CustomJoint("back", *pelvis, Vec3(-0.10580341146089615456, 0.08563036776626650748, 0.00000000000000000000), Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), *torso, Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), st_back);
	...
	acromial_r = new OpenSim::CustomJoint("acromial_r", *torso, Vec3(0.00328743550347178337, 0.38709422806331778011, 0.22677964232860256533), Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), *humerus_r, Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), st_acromial_r);
	...
	elbow_r = new OpenSim::CustomJoint("elbow_r", *humerus_r, Vec3(0.01433450623168792265, -0.31220192502008498048, -0.01046405868023779842), Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), *ulna_r, Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), st_elbow_r);
	...
	radioulnar_r = new OpenSim::CustomJoint("radioulnar_r", *ulna_r, Vec3(-0.00784928664796253305, -0.01517699887469134250, 0.03043450923722413118), Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), *radius_r, Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), st_radioulnar_r);

	OpenSim::WeldJoint* radius_hand_r;
	radius_hand_r = new OpenSim::WeldJoint("radius_hand_r", *radius_r, Vec3(-0.01026463128320594456, -0.27518709860890910868, 0.01588059926843616437), Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), *hand_r, Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000));
	...
	acromial_l = new OpenSim::CustomJoint("acromial_l", *torso, Vec3(0.00328743550347178337, 0.38709422806331778011, -0.22677964232860256533), Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), *humerus_l, Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), st_acromial_l);
	...
	elbow_l = new OpenSim::CustomJoint("elbow_l", *humerus_l, Vec3(0.01433450623168792265, -0.31220192502008498048, 0.01046405868023779842), Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), *ulna_l, Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), st_elbow_l);
	...
	radioulnar_l = new OpenSim::CustomJoint("radioulnar_l", *ulna_l, Vec3(-0.00784928664796253305, -0.01517699887469134250, -0.03043450923722413118), Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), *radius_l, Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), st_radioulnar_l);

	OpenSim::WeldJoint* radius_hand_l;
	radius_hand_l = new OpenSim::WeldJoint("radius_hand_l", *radius_l, Vec3(-0.01026463128320594456, -0.27518709860890910868, -0.01588059926843616437), Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), *hand_l, Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000));
	...
	Vec3 SmoothSphereHalfSpaceForce_s1_r_location(-0.00053387038401556521, -0.01000000000000000021, -0.00632913523202358747);
	...
	Vec3 SmoothSphereHalfSpaceForce_s2_r_location(0.07599217840418938386, -0.01000000000000000021, 0.02533199267103653646);
	...
	Vec3 SmoothSphereHalfSpaceForce_s3_r_location(0.20897849061152085071, -0.01000000000000000021, 0.02682903858559906526);
	...
	Vec3 SmoothSphereHalfSpaceForce_s4_r_location(0.20897849061152085071, -0.01000000000000000021, -0.01266536306736489904);
	...
	Vec3 SmoothSphereHalfSpaceForce_s5_r_location(0.06732147084827137806, -0.01000000000000000021, -0.00432813452101060703);
	...
	Vec3 SmoothSphereHalfSpaceForce_s6_r_location(0.00000220136675473869, -0.01000000000000000021, 0.02823616042238330862);
	...
	Vec3 SmoothSphereHalfSpaceForce_s1_l_location(-0.00053387038401556521, -0.01000000000000000021, 0.00632913523202358747);
	...
	Vec3 SmoothSphereHalfSpaceForce_s2_l_location(0.07599217840418938386, -0.01000000000000000021, -0.02533199267103653646);
	...
	Vec3 SmoothSphereHalfSpaceForce_s3_l_location(0.20897849061152085071, -0.01000000000000000021, -0.02682903858559906526);
	...
	Vec3 SmoothSphereHalfSpaceForce_s4_l_location(0.20897849061152085071, -0.01000000000000000021, 0.01266536306736489904);
	...
	Vec3 SmoothSphereHalfSpaceForce_s5_l_location(0.06732147084827137806, -0.01000000000000000021, 0.00432813452101060703);
	...
	Vec3 SmoothSphereHalfSpaceForce_s6_l_location(0.00000220136675473869, -0.01000000000000000021, -0.02823616042238330862);
