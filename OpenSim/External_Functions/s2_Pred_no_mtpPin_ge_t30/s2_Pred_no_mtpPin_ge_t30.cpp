...
int F_generic(const T** arg, T** res) {
	...
	OpenSim::Body* torso;
	torso = new OpenSim::Body("torso", 28.766519877708397, Vec3(-0.02676026676359908804, 0.30650513962530268053, 0.00000000000000000000), Inertia(1.5811259555695107, 0.8101326954443983, 1.5349092524938606, 0., 0., 0.));
	model->addBody(torso);
