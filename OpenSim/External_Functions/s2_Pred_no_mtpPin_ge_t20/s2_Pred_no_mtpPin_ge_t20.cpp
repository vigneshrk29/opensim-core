...
int F_generic(const T** arg, T** res) {
	...
	OpenSim::Body* torso;
	torso = new OpenSim::Body("torso", 26.55371065634621174922, Vec3(-0.02676026676359908804, 0.30650513962530268053, 0.00000000000000000000), Inertia(1.45950088206416350722, 0.74781479579482912357, 1.41683930999433282949, 0., 0., 0.));
	model->addBody(torso);
