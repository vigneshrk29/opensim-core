...
int F_generic(const T** arg, T** res) {
    ...
    osim_double_adouble radiusSphere_s2 = 0.025;
    osim_double_adouble radiusSphere_s3 = 0.025;
    osim_double_adouble stiffness_s1 = 3000000;
    osim_double_adouble stiffness_s2 = 1500000;
    osim_double_adouble stiffness_s3 = 1500000;
    ...
    Vec3 locSphere_s1 = Vec3(0.01, 0, 0);
    Vec3 locSphere_s2 = Vec3(0.025, -0.01, 0);
    Vec3 locSphere_s3 = Vec3(0.05, -0.01, 0);
    Vec3 normal = Vec3(0, 1, 0);
    osim_double_adouble offset = 0;
    /// Right foot contact shere specifications
    HC_s1_r = new HuntCrossleyForce_smooth("sphere_heel_r", "calcn_r", locSphere_s1, radiusSphere_s1,
        stiffness_s1, dissipation, staticFriction, dynamicFriction, viscousFriction, transitionVelocity, normal, offset);
    HC_s2_r = new HuntCrossleyForce_smooth("sphere_front_r", "toes_r", locSphere_s2, radiusSphere_s2,
        stiffness_s2, dissipation, staticFriction, dynamicFriction, viscousFriction, transitionVelocity, normal, offset);
    HC_s3_r = new HuntCrossleyForce_smooth("sphere_front2_r", "calcn_r", locSphere_s3, radiusSphere_s3,
    ...
    HC_s1_l = new HuntCrossleyForce_smooth("sphere_heel_l", "calcn_l", locSphere_s1, radiusSphere_s1,
        stiffness_s1, dissipation, staticFriction, dynamicFriction, viscousFriction, transitionVelocity, normal, offset);
    HC_s2_l = new HuntCrossleyForce_smooth("sphere_front_l", "toes_l", locSphere_s2, radiusSphere_s2,
        stiffness_s2, dissipation, staticFriction, dynamicFriction, viscousFriction, transitionVelocity, normal, offset);
    HC_s3_l = new HuntCrossleyForce_smooth("sphere_front2_l", "calcn_l", locSphere_s3, radiusSphere_s3,
        stiffness_s3, dissipation, staticFriction, dynamicFriction, viscousFriction, transitionVelocity, normal, offset);
