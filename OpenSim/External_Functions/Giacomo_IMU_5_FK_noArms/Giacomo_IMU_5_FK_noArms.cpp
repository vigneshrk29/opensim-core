...
constexpr int NP = 8*6;         // # parameters
constexpr int NR = ndof + 2*8*3 + 8*9;    // # residual torques + #IMU data
...
int F_generic(const T** arg, T** res) {
    ...
    int nc = 3;
    SimTK::Vec3 translation_pelvis_imu;
    SimTK::Vec3 translation_torso_imu;
    SimTK::Vec3 translation_femur_l_imu;
    SimTK::Vec3 translation_femur_r_imu;
    SimTK::Vec3 translation_tibia_l_imu;
    SimTK::Vec3 translation_tibia_r_imu;
    SimTK::Vec3 translation_calcn_l_imu;
    SimTK::Vec3 translation_calcn_r_imu;

    SimTK::Vec3 orientation_XYZ_pelvis_imu;
    SimTK::Vec3 orientation_XYZ_torso_imu;
    SimTK::Vec3 orientation_XYZ_femur_l_imu;
    SimTK::Vec3 orientation_XYZ_femur_r_imu;
    SimTK::Vec3 orientation_XYZ_tibia_l_imu;
    SimTK::Vec3 orientation_XYZ_tibia_r_imu;
    SimTK::Vec3 orientation_XYZ_calcn_l_imu;
    SimTK::Vec3 orientation_XYZ_calcn_r_imu;

    for (int i = 0; i < nc; ++i) {
        translation_pelvis_imu[i]       = up[i];
        translation_torso_imu[i]        = up[i + nc];
        translation_femur_l_imu[i]      = up[i + nc + nc];
        translation_femur_r_imu[i]      = up[i + nc + nc + nc];
        translation_tibia_l_imu[i]      = up[i + nc + nc + nc + nc];
        translation_tibia_r_imu[i]      = up[i + nc + nc + nc + nc + nc];
        translation_calcn_l_imu[i]      = up[i + nc + nc + nc + nc + nc + nc];
        translation_calcn_r_imu[i]      = up[i + nc + nc + nc + nc + nc + nc + nc];

        orientation_XYZ_pelvis_imu[i]   = up[i + nc + nc + nc + nc + nc + nc + nc + nc];
        orientation_XYZ_torso_imu[i]    = up[i + nc + nc + nc + nc + nc + nc + nc + nc + nc];
        orientation_XYZ_femur_l_imu[i]  = up[i + nc + nc + nc + nc + nc + nc + nc + nc + nc + nc];
        orientation_XYZ_femur_r_imu[i]  = up[i + nc + nc + nc + nc + nc + nc + nc + nc + nc + nc + nc];
        orientation_XYZ_tibia_l_imu[i]  = up[i + nc + nc + nc + nc + nc + nc + nc + nc + nc + nc + nc + nc];
        orientation_XYZ_tibia_r_imu[i]  = up[i + nc + nc + nc + nc + nc + nc + nc + nc + nc + nc + nc + nc + nc];
        orientation_XYZ_calcn_l_imu[i]  = up[i + nc + nc + nc + nc + nc + nc + nc + nc + nc + nc + nc + nc + nc + nc];
        orientation_XYZ_calcn_r_imu[i]  = up[i + nc + nc + nc + nc + nc + nc + nc + nc + nc + nc + nc + nc + nc + nc + nc];
    }
