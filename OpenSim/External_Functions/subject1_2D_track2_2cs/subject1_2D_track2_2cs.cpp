...
constexpr int NP = 20;      // # parameters
...
int F_generic(const T** arg, T** res) {
    ...
    for (int i = 0; i < nc; ++i) {
        ...
        AppliedPointForce_s1_r[i]   = up[i + nc + nc];
        AppliedPointForce_s2_r[i]   = up[i + nc + nc + nc];
    }
    /// Extract contact sphere locations
    Vec3 locSphere_s1_r, locSphere_s2_r;
    for (int i = 0; i < nc; ++i) {
        locSphere_s1_r[i]   = up[i + nc + nc + nc + nc];
        locSphere_s2_r[i]   = up[i + nc + nc + nc + nc + nc];
    }
    ...
    /// Extract radii
    osim_double_adouble radiusSphere_s1, radiusSphere_s2;
    radiusSphere_s1 =  up[nc + nc + nc + nc + nc + nc];
    radiusSphere_s2 =  up[nc + nc + nc + nc + nc + nc + 1];
    ...
    Vec3 AppliedPointTorque_s1_l, AppliedPointTorque_s2_l;
    Vec3 AppliedPointTorque_s1_r, AppliedPointTorque_s2_r;
    ...
    /// Contact torques
    Vec3 MOM_l = AppliedPointTorque_s1_l + AppliedPointTorque_s2_l;
    Vec3 MOM_r = AppliedPointTorque_s1_r + AppliedPointTorque_s2_r;
    /// Contact forces
    Vec3 GRF_l = AppliedPointForce_s1_l + AppliedPointForce_s2_l;
    Vec3 GRF_r = AppliedPointForce_s1_r + AppliedPointForce_s2_r;
