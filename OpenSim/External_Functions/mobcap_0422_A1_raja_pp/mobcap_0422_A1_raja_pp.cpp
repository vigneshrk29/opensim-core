...
int F_generic(const T** arg, T** res) {
	...
	OpenSim::Body* pelvis;
	pelvis = new OpenSim::Body("pelvis", 13.00617757542774555191, Vec3(-0.08053549893442867036, 0.00000000000000000000, 0.00000000000000000000), Inertia(0.11352934149222827787, 0.09619071638106110878, 0.06394308241634258372, 0., 0., 0.));
	model->addBody(pelvis);

	OpenSim::Body* femur_r;
	femur_r = new OpenSim::Body("femur_r", 10.27219666299427913714, Vec3(0.00000000000000000000, -0.18339425796983810368, 0.00000000000000000000), Inertia(0.17209537785631415230, 0.04511238060311147796, 0.18147772481935445232, 0., 0., 0.));
	model->addBody(femur_r);

	OpenSim::Body* tibia_r;
	tibia_r = new OpenSim::Body("tibia_r", 4.09445557959568429141, Vec3(0.00000000000000000000, -0.21654375575847664703, 0.00000000000000000000), Inertia(0.07487696532019773310, 0.00757683577644858042, 0.07591692317186712891, 0., 0., 0.));
	model->addBody(tibia_r);

	OpenSim::Body* talus_r;
	talus_r = new OpenSim::Body("talus_r", 0.11043710261889910784, Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), Inertia(0.00112685045146934735, 0.00112685045146934735, 0.00112685045146934735, 0., 0., 0.));
	model->addBody(talus_r);

	OpenSim::Body* calcn_r;
	calcn_r = new OpenSim::Body("calcn_r", 1.38046378273623870925, Vec3(0.10101262086888562752, 0.03030378626066568618, 0.00000000000000000000), Inertia(0.00157759063205708617, 0.00439471676073045509, 0.00462008685102432461, 0., 0., 0.));
	model->addBody(calcn_r);

	OpenSim::Body* toes_r;
	toes_r = new OpenSim::Body("toes_r", 0.23920676427253542706, Vec3(0.03495036682063442507, 0.00606075725213313810, -0.01767720865205498620), Inertia(0.00011268504514693476, 0.00022537009029386951, 0.00112685045146934735, 0., 0., 0.));
	model->addBody(toes_r);

	OpenSim::Body* femur_l;
	femur_l = new OpenSim::Body("femur_l", 10.27219666299427913714, Vec3(0.00000000000000000000, -0.18339425796983810368, 0.00000000000000000000), Inertia(0.17209537785631415230, 0.04511238060311147796, 0.18147772481935445232, 0., 0., 0.));
	model->addBody(femur_l);

	OpenSim::Body* tibia_l;
	tibia_l = new OpenSim::Body("tibia_l", 4.09445557959568429141, Vec3(0.00000000000000000000, -0.21654375575847664703, 0.00000000000000000000), Inertia(0.07487696532019773310, 0.00757683577644858042, 0.07591692317186712891, 0., 0., 0.));
	model->addBody(tibia_l);

	OpenSim::Body* talus_l;
	talus_l = new OpenSim::Body("talus_l", 0.11043710261889910784, Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), Inertia(0.00112685045146934735, 0.00112685045146934735, 0.00112685045146934735, 0., 0., 0.));
	model->addBody(talus_l);

	OpenSim::Body* calcn_l;
	calcn_l = new OpenSim::Body("calcn_l", 1.38046378273623870925, Vec3(0.10101262086888562752, 0.03030378626066568618, 0.00000000000000000000), Inertia(0.00157759063205708617, 0.00439471676073045509, 0.00462008685102432461, 0., 0., 0.));
	model->addBody(calcn_l);

	OpenSim::Body* toes_l;
	toes_l = new OpenSim::Body("toes_l", 0.23920676427253542706, Vec3(0.03495036682063442507, 0.00606075725213313810, 0.01767720865205498620), Inertia(0.00011268504514693476, 0.00022537009029386951, 0.00112685045146934735, 0., 0., 0.));
	model->addBody(toes_l);

	OpenSim::Body* torso;
	torso = new OpenSim::Body("torso", 29.62651977116158263925, Vec3(-0.03058212974696663047, 0.32620938396764409539, 0.00000000000000000000), Inertia(1.62839507811566708284, 0.83435231028578260570, 1.58079668688692165368, 0., 0., 0.));
	model->addBody(torso);

	OpenSim::Body* humerus_r;
	humerus_r = new OpenSim::Body("humerus_r", 2.24463411072912455424, Vec3(0.00000000000000000000, -0.17815709873996421475, 0.00000000000000000000), Inertia(0.01547395797472780887, 0.00533803623085997870, 0.01736901912632891204, 0., 0., 0.));
	model->addBody(humerus_r);

	OpenSim::Body* ulna_r;
	ulna_r = new OpenSim::Body("ulna_r", 0.67090539840981200381, Vec3(0.00000000000000000000, -0.13702705598097578155, 0.00000000000000000000), Inertia(0.00422822833329866352, 0.00088218943618452884, 0.00458652857356131333, 0., 0., 0.));
	model->addBody(ulna_r);

	OpenSim::Body* radius_r;
	radius_r = new OpenSim::Body("radius_r", 0.67090539840981200381, Vec3(0.00000000000000000000, -0.13702705598097578155, 0.00000000000000000000), Inertia(0.00422822833329866352, 0.00088218943618452884, 0.00458652857356131333, 0., 0., 0.));
	model->addBody(radius_r);

	OpenSim::Body* hand_r;
	hand_r = new OpenSim::Body("hand_r", 0.50524974448146342532, Vec3(0.00000000000000000000, -0.07741843913731213944, 0.00000000000000000000), Inertia(0.00127332196937961131, 0.00078083757539310235, 0.00191283793606354170, 0., 0., 0.));
	model->addBody(hand_r);

	OpenSim::Body* humerus_l;
	humerus_l = new OpenSim::Body("humerus_l", 2.24463411072912455424, Vec3(0.00000000000000000000, -0.17815709873996421475, 0.00000000000000000000), Inertia(0.01547395797472780887, 0.00533803623085997870, 0.01736901912632891204, 0., 0., 0.));
	model->addBody(humerus_l);

	OpenSim::Body* ulna_l;
	ulna_l = new OpenSim::Body("ulna_l", 0.67090539840981200381, Vec3(0.00000000000000000000, -0.13702705598097578155, 0.00000000000000000000), Inertia(0.00422822833329866352, 0.00088218943618452884, 0.00458652857356131333, 0., 0., 0.));
	model->addBody(ulna_l);

	OpenSim::Body* radius_l;
	radius_l = new OpenSim::Body("radius_l", 0.67090539840981200381, Vec3(0.00000000000000000000, -0.13702705598097578155, 0.00000000000000000000), Inertia(0.00422822833329866352, 0.00088218943618452884, 0.00458652857356131333, 0., 0., 0.));
	model->addBody(radius_l);

	OpenSim::Body* hand_l;
	hand_l = new OpenSim::Body("hand_l", 0.50524974448146342532, Vec3(0.00000000000000000000, -0.07741843913731213944, 0.00000000000000000000), Inertia(0.00127332196937961131, 0.00078083757539310235, 0.00191283793606354170, 0., 0., 0.));
	...
	hip_r = new OpenSim::CustomJoint("hip_r", *pelvis, Vec3(-0.06410489021264367815, -0.08940921232479924485, 0.09082192565824458164), Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), *femur_r, Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), st_hip_r);
	...
	st_walker_knee_r[1].setFunction(new Constant(0));
	st_walker_knee_r[1].setAxis(Vec3(0.00000000000000000000, 1.00000000000000000000, 0.00000000000000000000));
	st_walker_knee_r[2].setFunction(new Constant(0));
	st_walker_knee_r[2].setAxis(Vec3(0.00000000000000000000, 0.00000000000000000000, 1.00000000000000000000));
	...
	walker_knee_r = new OpenSim::CustomJoint("walker_knee_r", *femur_r, Vec3(-0.00872740909985876556, -0.44010306753750089159, -0.00296667182010032201), Vec3(-1.64156999999999997364, 1.44618000000000002103, 1.57079999999999997407), *tibia_r, Vec3(-0.00938264260288391647, -0.00409983325042883370, -0.00172207378642121392), Vec3(-1.64156999999999997364, 1.44618000000000002103, 1.57079999999999997407), st_walker_knee_r);

	OpenSim::PinJoint* ankle_r;
	ankle_r = new OpenSim::PinJoint("ankle_r", *tibia_r, Vec3(-0.01159848718577807455, -0.46393948743112300992, 0.00000000000000000000), Vec3(0.17589499999999999580, -0.10520799999999999597, 0.01866220000000000032), *talus_r, Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), Vec3(0.17589499999999999580, -0.10520799999999999597, 0.01866220000000000032));

	OpenSim::PinJoint* subtalar_r;
	subtalar_r = new OpenSim::PinJoint("subtalar_r", *talus_r, Vec3(-0.04926385519775552252, -0.04237479445449752330, 0.00800019957281574226), Vec3(-1.76818999999999992845, 0.90622300000000000075, 1.81960000000000010623), *calcn_r, Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), Vec3(-1.76818999999999992845, 0.90622300000000000075, 1.81960000000000010623));

	OpenSim::WeldJoint* mtp_r;
	mtp_r = new OpenSim::WeldJoint("mtp_r", *calcn_r, Vec3(0.18061056611356748891, -0.00202025241737771241, 0.00109093630538396489), Vec3(-3.14158999999999988262, 0.61990100000000003533, 0.00000000000000000000), *toes_r, Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), Vec3(-3.14158999999999988262, 0.61990100000000003533, 0.00000000000000000000));
	...
	hip_l = new OpenSim::CustomJoint("hip_l", *pelvis, Vec3(-0.06410489021264367815, -0.08940921232479924485, -0.09082192565824458164), Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), *femur_l, Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), st_hip_l);
	...
	st_walker_knee_l[1].setFunction(new Constant(0));
	st_walker_knee_l[1].setAxis(Vec3(0.00000000000000000000, 1.00000000000000000000, 0.00000000000000000000));
	st_walker_knee_l[2].setFunction(new Constant(0));
	st_walker_knee_l[2].setAxis(Vec3(0.00000000000000000000, 0.00000000000000000000, 1.00000000000000000000));
	...
	walker_knee_l = new OpenSim::CustomJoint("walker_knee_l", *femur_l, Vec3(-0.00872740909985876556, -0.44010306753750089159, 0.00296667182010032201), Vec3(1.64156999999999997364, -1.44618000000000002103, 1.57079999999999997407), *tibia_l, Vec3(-0.00938264260288391647, -0.00409983325042883370, 0.00172207378642121392), Vec3(1.64156999999999997364, -1.44618000000000002103, 1.57079999999999997407), st_walker_knee_l);

	OpenSim::PinJoint* ankle_l;
	ankle_l = new OpenSim::PinJoint("ankle_l", *tibia_l, Vec3(-0.01159848718577807455, -0.46393948743112300992, 0.00000000000000000000), Vec3(-0.17589499999999999580, 0.10520799999999999597, 0.01866220000000000032), *talus_l, Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), Vec3(-0.17589499999999999580, 0.10520799999999999597, 0.01866220000000000032));

	OpenSim::PinJoint* subtalar_l;
	subtalar_l = new OpenSim::PinJoint("subtalar_l", *talus_l, Vec3(-0.04926385519775552252, -0.04237479445449752330, -0.00800019957281574226), Vec3(1.76818999999999992845, -0.90622300000000000075, 1.81960000000000010623), *calcn_l, Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), Vec3(1.76818999999999992845, -0.90622300000000000075, 1.81960000000000010623));

	OpenSim::WeldJoint* mtp_l;
	mtp_l = new OpenSim::WeldJoint("mtp_l", *calcn_l, Vec3(0.18061056611356748891, -0.00202025241737771241, -0.00109093630538396489), Vec3(-3.14158999999999988262, -0.61990100000000003533, 0.00000000000000000000), *toes_l, Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), Vec3(-3.14158999999999988262, -0.61990100000000003533, 0.00000000000000000000));
	...
	back = new OpenSim::CustomJoint("back", *pelvis, Vec3(-0.11470897797308299282, 0.09283795138834423366, 0.00000000000000000000), Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), *torso, Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), st_back);
	...
	acromial_r = new OpenSim::CustomJoint("acromial_r", *torso, Vec3(0.00321622064505599093, 0.37870870669993678126, 0.18884117418614987383), Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), *humerus_r, Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), st_acromial_r);

	OpenSim::PinJoint* elbow_r;
	elbow_r = new OpenSim::PinJoint("elbow_r", *humerus_r, Vec3(0.01423506647845065344, -0.31003615231173953237, -0.01039146856822383003), Vec3(-0.02286269999999999969, 0.22801799999999999846, 0.00516889999999999971), *ulna_r, Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), Vec3(-0.02286269999999999969, 0.22801799999999999846, 0.00516889999999999971));

	OpenSim::PinJoint* radioulnar_r;
	radioulnar_r = new OpenSim::PinJoint("radioulnar_r", *ulna_r, Vec3(-0.00764804816912693745, -0.01478789394021615307, 0.02965423523046497450), Vec3(-1.56884000000000001229, 0.05642799999999999899, 1.53614000000000006096), *radius_r, Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), Vec3(-1.56884000000000001229, 0.05642799999999999899, 1.53614000000000006096));

	OpenSim::WeldJoint* radius_hand_r;
	radius_hand_r = new OpenSim::WeldJoint("radius_hand_r", *radius_r, Vec3(-0.01000146867010698153, -0.26813190549354332104, 0.01547345556441468914), Vec3(-1.57079999999999997407, 0.00000000000000000000, -1.57079999999999997407), *hand_r, Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), Vec3(-1.57079999999999997407, 0.00000000000000000000, -1.57079999999999997407));
	...
	acromial_l = new OpenSim::CustomJoint("acromial_l", *torso, Vec3(0.00321622064505599093, 0.37870870669993678126, -0.18884117418614987383), Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), *humerus_l, Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), st_acromial_l);

	OpenSim::PinJoint* elbow_l;
	elbow_l = new OpenSim::PinJoint("elbow_l", *humerus_l, Vec3(0.01423506647845065344, -0.31003615231173953237, 0.01039146856822383003), Vec3(0.02286269999999999969, -0.22801799999999999846, 0.00516889999999999971), *ulna_l, Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), Vec3(0.02286269999999999969, -0.22801799999999999846, 0.00516889999999999971));

	OpenSim::PinJoint* radioulnar_l;
	radioulnar_l = new OpenSim::PinJoint("radioulnar_l", *ulna_l, Vec3(-0.00764804816912693745, -0.01478789394021615307, -0.02965423523046497450), Vec3(1.56884000000000001229, -0.05642799999999999899, 1.53614000000000006096), *radius_l, Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), Vec3(1.56884000000000001229, -0.05642799999999999899, 1.53614000000000006096));

	OpenSim::WeldJoint* radius_hand_l;
	radius_hand_l = new OpenSim::WeldJoint("radius_hand_l", *radius_l, Vec3(-0.01000146867010698153, -0.26813190549354332104, -0.01547345556441468914), Vec3(1.57079999999999997407, 0.00000000000000000000, 1.57079999999999997407), *hand_l, Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), Vec3(1.57079999999999997407, 0.00000000000000000000, 1.57079999999999997407));
	...
	Vec3 SmoothSphereHalfSpaceForce_s1_r_location(-0.00046589037981990486, -0.01000000000000000021, -0.00552321931589492502);
	...
	Vec3 SmoothSphereHalfSpaceForce_s2_r_location(0.06631576862116694837, -0.01000000000000000021, 0.02210636146986600520);
	...
	Vec3 SmoothSphereHalfSpaceForce_s3_r_location(0.18236836370820910802, -0.01000000000000000021, 0.02341278211170299065);
	...
	Vec3 SmoothSphereHalfSpaceForce_s4_r_location(0.18236836370820910802, -0.01000000000000000021, -0.01105262810352782531);
	...
	Vec3 SmoothSphereHalfSpaceForce_s5_r_location(0.05874913942149179863, -0.01000000000000000021, -0.00377701460181856328);
	...
	Vec3 SmoothSphereHalfSpaceForce_s6_r_location(0.00000192105729067417, -0.01000000000000000021, 0.02464072909400493241);
	...
	Vec3 SmoothSphereHalfSpaceForce_s1_l_location(-0.00046589037981990486, -0.01000000000000000021, 0.00552321931589492502);
	...
	Vec3 SmoothSphereHalfSpaceForce_s2_l_location(0.06631576862116694837, -0.01000000000000000021, -0.02210636146986600520);
	...
	Vec3 SmoothSphereHalfSpaceForce_s3_l_location(0.18236836370820910802, -0.01000000000000000021, -0.02341278211170299065);
	...
	Vec3 SmoothSphereHalfSpaceForce_s4_l_location(0.18236836370820910802, -0.01000000000000000021, 0.01105262810352782531);
	...
	Vec3 SmoothSphereHalfSpaceForce_s5_l_location(0.05874913942149179863, -0.01000000000000000021, 0.00377701460181856328);
	...
	Vec3 SmoothSphereHalfSpaceForce_s6_l_location(0.00000192105729067417, -0.01000000000000000021, -0.02464072909400493241);
