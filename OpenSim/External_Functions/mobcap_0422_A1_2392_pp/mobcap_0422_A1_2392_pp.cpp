...
int F_generic(const T** arg, T** res) {
	...
	OpenSim::Body* pelvis;
	pelvis = new OpenSim::Body("pelvis", 13.03600897230877464494, Vec3(-0.08053549893442867036, 0.00000000000000000000, 0.00000000000000000000), Inertia(0.11378973612578265062, 0.09641134257349871783, 0.06408974437434644678, 0., 0., 0.));
	model->addBody(pelvis);

	OpenSim::Body* femur_r;
	femur_r = new OpenSim::Body("femur_r", 10.29575731128749538357, Vec3(0.00000000000000000000, -0.18978138862719809432, 0.00000000000000000000), Inertia(0.18471405821627448485, 0.04842019001785835552, 0.19478435414591455110, 0., 0., 0.));
	model->addBody(femur_r);

	OpenSim::Body* tibia_r;
	tibia_r = new OpenSim::Body("tibia_r", 4.10384675764921347252, Vec3(0.00000000000000000000, -0.20213825042863825532, 0.00000000000000000000), Inertia(0.06539565304786006117, 0.00661741727270012594, 0.06630392600685812432, 0., 0., 0.));
	model->addBody(tibia_r);

	OpenSim::Body* talus_r;
	talus_r = new OpenSim::Body("talus_r", 0.11069040479161736112, Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), Inertia(0.00112943503274608257, 0.00112943503274608257, 0.00112943503274608257, 0., 0., 0.));
	model->addBody(talus_r);

	OpenSim::Body* calcn_r;
	calcn_r = new OpenSim::Body("calcn_r", 1.38363005989521692385, Vec3(0.10101262086888561365, 0.03030378626066567924, 0.00000000000000000000), Inertia(0.00158120904584451534, 0.00440479662770972176, 0.00463068363425893879, 0., 0., 0.));
	model->addBody(calcn_r);

	OpenSim::Body* toes_r;
	toes_r = new OpenSim::Body("toes_r", 0.23975541677864317669, Vec3(0.03495036682063441813, 0.00606075725213313637, -0.01767720865205498273), Inertia(0.00011294350327460826, 0.00022588700654921652, 0.00112943503274608257, 0., 0., 0.));
	model->addBody(toes_r);

	OpenSim::Body* femur_l;
	femur_l = new OpenSim::Body("femur_l", 10.29575731128749538357, Vec3(0.00000000000000000000, -0.18978138862719809432, 0.00000000000000000000), Inertia(0.18471405821627448485, 0.04842019001785835552, 0.19478435414591455110, 0., 0., 0.));
	model->addBody(femur_l);

	OpenSim::Body* tibia_l;
	tibia_l = new OpenSim::Body("tibia_l", 4.10384675764921347252, Vec3(0.00000000000000000000, -0.20213825042863825532, 0.00000000000000000000), Inertia(0.06539565304786006117, 0.00661741727270012594, 0.06630392600685812432, 0., 0., 0.));
	model->addBody(tibia_l);

	OpenSim::Body* talus_l;
	talus_l = new OpenSim::Body("talus_l", 0.11069040479161736112, Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), Inertia(0.00112943503274608257, 0.00112943503274608257, 0.00112943503274608257, 0., 0., 0.));
	model->addBody(talus_l);

	OpenSim::Body* calcn_l;
	calcn_l = new OpenSim::Body("calcn_l", 1.38363005989521692385, Vec3(0.10101262086888561365, 0.03030378626066567924, 0.00000000000000000000), Inertia(0.00158120904584451534, 0.00440479662770972176, 0.00463068363425893879, 0., 0., 0.));
	model->addBody(calcn_l);

	OpenSim::Body* toes_l;
	toes_l = new OpenSim::Body("toes_l", 0.23975541677864317669, Vec3(0.03495036682063441813, 0.00606075725213313637, 0.01767720865205498273), Inertia(0.00011294350327460826, 0.00022588700654921652, 0.00112943503274608257, 0., 0., 0.));
	model->addBody(toes_l);

	OpenSim::Body* torso;
	torso = new OpenSim::Body("torso", 29.69447213182802158826, Vec3(-0.03058212974696662700, 0.32620938396764403988, 0.00000000000000000000), Inertia(1.63213001865239792920, 0.83626600820066909758, 1.58442245418721094907, 0., 0., 0.));
	model->addBody(torso);

	OpenSim::Body* humerus_r;
	humerus_r = new OpenSim::Body("humerus_r", 2.24978247738962311431, Vec3(0.00000000000000000000, -0.17815709873996427026, 0.00000000000000000000), Inertia(0.01550944955393987988, 0.00535027972641773358, 0.01740885728015903813, 0., 0., 0.));
	model->addBody(humerus_r);

	OpenSim::Body* ulna_r;
	ulna_r = new OpenSim::Body("ulna_r", 0.67244420910907554134, Vec3(0.00000000000000000000, -0.13348519039594622382, 0.00000000000000000000), Inertia(0.00402167452455544274, 0.00083909346933668590, 0.00436247138669704215, 0., 0., 0.));
	model->addBody(ulna_r);

	OpenSim::Body* radius_r;
	radius_r = new OpenSim::Body("radius_r", 0.67244420910907554134, Vec3(0.00000000000000000000, -0.13348519039594622382, 0.00000000000000000000), Inertia(0.00402167452455544274, 0.00083909346933668590, 0.00436247138669704215, 0., 0., 0.));
	model->addBody(radius_r);

	OpenSim::Body* hand_r;
	hand_r = new OpenSim::Body("hand_r", 0.50640860192164938169, Vec3(0.00000000000000000000, -0.07541733283561052881, 0.00000000000000000000), Inertia(0.00121111872920440754, 0.00074269276331256830, 0.00181939360665236104, 0., 0., 0.));
	model->addBody(hand_r);

	OpenSim::Body* humerus_l;
	humerus_l = new OpenSim::Body("humerus_l", 2.24978247738962311431, Vec3(0.00000000000000000000, -0.17815709873996427026, 0.00000000000000000000), Inertia(0.01550944955393987988, 0.00535027972641773358, 0.01740885728015903813, 0., 0., 0.));
	model->addBody(humerus_l);

	OpenSim::Body* ulna_l;
	ulna_l = new OpenSim::Body("ulna_l", 0.67244420910907554134, Vec3(0.00000000000000000000, -0.13348519039594622382, 0.00000000000000000000), Inertia(0.00402167452455544274, 0.00083909346933668590, 0.00436247138669704215, 0., 0., 0.));
	model->addBody(ulna_l);

	OpenSim::Body* radius_l;
	radius_l = new OpenSim::Body("radius_l", 0.67244420910907554134, Vec3(0.00000000000000000000, -0.13348519039594622382, 0.00000000000000000000), Inertia(0.00402167452455544274, 0.00083909346933668590, 0.00436247138669704215, 0., 0., 0.));
	model->addBody(radius_l);

	OpenSim::Body* hand_l;
	hand_l = new OpenSim::Body("hand_l", 0.50640860192164938169, Vec3(0.00000000000000000000, -0.07541733283561052881, 0.00000000000000000000), Inertia(0.00121111872920440754, 0.00074269276331256830, 0.00181939360665236104, 0., 0., 0.));
	...
	hip_r = new OpenSim::CustomJoint("hip_r", *pelvis, Vec3(-0.08053549893442867036, -0.07529556548183502507, 0.09815727145306010759), Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), *femur_r, Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), st_hip_r);
	...
	knee_r = new OpenSim::CustomJoint("knee_r", *femur_r, Vec3(-0.00502346000000000042, -0.44187883000000000022, 0.00000000000000000000), Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), *tibia_r, Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), st_knee_r);
	...
	ankle_r = new OpenSim::CustomJoint("ankle_r", *tibia_r, Vec3(0.00000000000000000000, -0.46555676317254662822, 0.00000000000000000000), Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), *talus_r, Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), st_ankle_r);
	...
	hip_l = new OpenSim::CustomJoint("hip_l", *pelvis, Vec3(-0.08053549893442867036, -0.07529556548183502507, -0.09815727145306010759), Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), *femur_l, Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), st_hip_l);
	...
	knee_l = new OpenSim::CustomJoint("knee_l", *femur_l, Vec3(-0.00502346000000000042, -0.44187883000000000022, 0.00000000000000000000), Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), *tibia_l, Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), st_knee_l);
	...
	ankle_l = new OpenSim::CustomJoint("ankle_l", *tibia_l, Vec3(0.00000000000000000000, -0.46555676317254662822, 0.00000000000000000000), Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), *talus_l, Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), st_ankle_l);
	...
	subtalar_l = new OpenSim::CustomJoint("subtalar_l", *talus_l, Vec3(-0.04926385519775550864, -0.04237479445449750942, -0.00800019957281574053), Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), *calcn_l, Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), st_subtalar_l);

	OpenSim::WeldJoint* mtp_l;
	mtp_l = new OpenSim::WeldJoint("mtp_l", *calcn_l, Vec3(0.18061056611356746116, -0.00202025241737771198, -0.00109093630538396446), Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), *toes_l, Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000));
	...
	acromial_r = new OpenSim::CustomJoint("acromial_r", *torso, Vec3(0.00321622064505599006, 0.37870870669993672575, 0.18884117418614987383), Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), *humerus_r, Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), st_acromial_r);
	...
	radioulnar_r = new OpenSim::CustomJoint("radioulnar_r", *ulna_r, Vec3(-0.00745036196468392819, -0.01440565751072451876, 0.02888773466996445369), Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), *radius_r, Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), st_radioulnar_r);

	OpenSim::WeldJoint* radius_hand_r;
	radius_hand_r = new OpenSim::WeldJoint("radius_hand_r", *radius_r, Vec3(-0.00974295142014635143, -0.26120125109454767065, 0.01507349878688096605), Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), *hand_r, Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000));
	...
	acromial_l = new OpenSim::CustomJoint("acromial_l", *torso, Vec3(0.00321622064505599006, 0.37870870669993672575, -0.18884117418614987383), Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), *humerus_l, Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), st_acromial_l);
	...
	radioulnar_l = new OpenSim::CustomJoint("radioulnar_l", *ulna_l, Vec3(-0.00745036196468392819, -0.01440565751072451876, -0.02888773466996445369), Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), *radius_l, Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), st_radioulnar_l);

	OpenSim::WeldJoint* radius_hand_l;
	radius_hand_l = new OpenSim::WeldJoint("radius_hand_l", *radius_l, Vec3(-0.00974295142014635143, -0.26120125109454767065, -0.01507349878688096605), Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), *hand_l, Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000));
	...
	Vec3 SmoothSphereHalfSpaceForce_s1_r_location(-0.00046589037981990475, -0.01000000000000000021, -0.00552321931589492329);
	...
	Vec3 SmoothSphereHalfSpaceForce_s2_r_location(0.06631576862116693449, -0.01000000000000000021, 0.02210636146986599826);
	...
	Vec3 SmoothSphereHalfSpaceForce_s3_r_location(0.18236836370820908027, -0.01000000000000000021, 0.02341278211170298718);
	...
	Vec3 SmoothSphereHalfSpaceForce_s4_r_location(0.18236836370820908027, -0.01000000000000000021, -0.01105262810352782184);
	...
	Vec3 SmoothSphereHalfSpaceForce_s5_r_location(0.05874913942149178475, -0.01000000000000000021, -0.00377701460181856241);
	...
	Vec3 SmoothSphereHalfSpaceForce_s6_r_location(0.00000192105729067417, -0.01000000000000000021, 0.02464072909400492895);
	...
	Vec3 SmoothSphereHalfSpaceForce_s1_l_location(-0.00046589037981990475, -0.01000000000000000021, 0.00552321931589492329);
	...
	Vec3 SmoothSphereHalfSpaceForce_s2_l_location(0.06631576862116693449, -0.01000000000000000021, -0.02210636146986599826);
	...
	Vec3 SmoothSphereHalfSpaceForce_s3_l_location(0.18236836370820908027, -0.01000000000000000021, -0.02341278211170298718);
	...
	Vec3 SmoothSphereHalfSpaceForce_s4_l_location(0.18236836370820908027, -0.01000000000000000021, 0.01105262810352782184);
	...
	Vec3 SmoothSphereHalfSpaceForce_s5_l_location(0.05874913942149178475, -0.01000000000000000021, 0.00377701460181856241);
	...
	Vec3 SmoothSphereHalfSpaceForce_s6_l_location(0.00000192105729067417, -0.01000000000000000021, -0.02464072909400492895);
