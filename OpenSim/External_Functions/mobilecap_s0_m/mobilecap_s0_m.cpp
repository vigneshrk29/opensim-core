...
constexpr int NR = nCoordinates + 3*29; 
...
int F_generic(const T** arg, T** res) {
	...
	mtp_l = new OpenSim::WeldJoint("mtp_l", *calcn_l, Vec3(0.17534105729217500103, -0.00196130936568428412, -0.00105910705746951341), Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), *toes_l, Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000));
