% This script generates the code necessary for building a model in C++.
% This is practical as for now we need to programmatically build the models
% when creating external functions. This is a drawback of our workflow
%
% Author: Echo Wang
% Date: 21/10/2019
