...
int F_generic(const T** arg, T** res) {
	...
	Vec3 SmoothSphereHalfSpaceForce_s1_r_location(-0.00047744940253422494, -0.01000000000000000021, -0.00566025373492130661);
	...
	Vec3 SmoothSphereHalfSpaceForce_s2_r_location(0.06796110303675625963, -0.01000000000000000021, 0.02265483369730270091);
	...
	Vec3 SmoothSphereHalfSpaceForce_s3_r_location(0.18689303335107970705, -0.01000000000000000021, 0.02399366742712679898);
	...
	Vec3 SmoothSphereHalfSpaceForce_s4_r_location(0.18689303335107970705, -0.01000000000000000021, -0.01132685050612604327);
	...
	Vec3 SmoothSphereHalfSpaceForce_s5_r_location(0.06020674118026236865, -0.01000000000000000021, -0.00387072462345845270);
	...
	Vec3 SmoothSphereHalfSpaceForce_s6_r_location(0.00000196871988646977, -0.01000000000000000021, 0.02525208051835740181);
	...
	Vec3 SmoothSphereHalfSpaceForce_s1_l_location(-0.00047744940253422494, -0.01000000000000000021, 0.00566025373492130661);
	...
	Vec3 SmoothSphereHalfSpaceForce_s2_l_location(0.06796110303675625963, -0.01000000000000000021, -0.02265483369730270091);
	...
	Vec3 SmoothSphereHalfSpaceForce_s3_l_location(0.18689303335107970705, -0.01000000000000000021, -0.02399366742712679898);
	...
	Vec3 SmoothSphereHalfSpaceForce_s4_l_location(0.18689303335107970705, -0.01000000000000000021, 0.01132685050612604327);
	...
	Vec3 SmoothSphereHalfSpaceForce_s5_l_location(0.06020674118026236865, -0.01000000000000000021, 0.00387072462345845270);
	...
	Vec3 SmoothSphereHalfSpaceForce_s6_l_location(0.00000196871988646977, -0.01000000000000000021, -0.02525208051835740181);
	...
	GRF_r = GRF_0[1] + GRF_1[1] + GRF_2[1] + GRF_3[1] + GRF_4[1] + GRF_5[1];
	GRF_l = GRF_6[1] + GRF_7[1] + GRF_8[1] + GRF_9[1] + GRF_10[1] + GRF_11[1];
	...
	Vec3 contactPointpos_InGround_HC_s1_l = pos_InGround_HC_s1_l - SmoothSphereHalfSpaceForce_s1_l_radius * normal;
	...
	Vec3 contactPointpos_InGround_HC_s1_r = pos_InGround_HC_s1_r - SmoothSphereHalfSpaceForce_s1_r_radius * normal;
	...
	Vec3 contactPointpos_InGround_HC_s2_r = pos_InGround_HC_s2_r - SmoothSphereHalfSpaceForce_s2_r_radius * normal;
	...
	Vec3 contactPointpos_InGround_HC_s3_r = pos_InGround_HC_s3_r - SmoothSphereHalfSpaceForce_s3_r_radius * normal;
	...
	Vec3 contactPointpos_InGround_HC_s4_r = pos_InGround_HC_s4_r - SmoothSphereHalfSpaceForce_s4_r_radius * normal;
	...
	Vec3 contactPointpos_InGround_HC_s5_r = pos_InGround_HC_s5_r - SmoothSphereHalfSpaceForce_s5_r_radius * normal;
	...
	Vec3 contactPointpos_InGround_HC_s6_r = pos_InGround_HC_s6_r - SmoothSphereHalfSpaceForce_s6_r_radius * normal;
	...
	Vec3 GRM_0 = (TR_GB_calcn_r*contactPointPos_InBody_HC_s1_r) % GRF_0[1];
	GRM_r += GRM_0;

	Vec3 GRM_1 = (TR_GB_calcn_r*contactPointPos_InBody_HC_s2_r) % GRF_1[1];
	GRM_r += GRM_1;

	Vec3 GRM_2 = (TR_GB_calcn_r*contactPointPos_InBody_HC_s3_r) % GRF_2[1];
	GRM_r += GRM_2;

	Vec3 GRM_3 = (TR_GB_calcn_r*contactPointPos_InBody_HC_s4_r) % GRF_3[1];
	GRM_r += GRM_3;

	Vec3 GRM_4 = (TR_GB_toes_r*contactPointPos_InBody_HC_s5_r) % GRF_4[1];
	GRM_r += GRM_4;

	Vec3 GRM_5 = (TR_GB_toes_r*contactPointPos_InBody_HC_s6_r) % GRF_5[1];
	GRM_r += GRM_5;

	Vec3 GRM_6 = (TR_GB_calcn_l*contactPointPos_InBody_HC_s1_l) % GRF_6[1];
	GRM_l += GRM_6;

	Vec3 GRM_7 = (TR_GB_calcn_l*contactPointPos_InBody_HC_s2_l) % GRF_7[1];
	GRM_l += GRM_7;

	Vec3 GRM_8 = (TR_GB_calcn_l*contactPointPos_InBody_HC_s3_l) % GRF_8[1];
	GRM_l += GRM_8;

	Vec3 GRM_9 = (TR_GB_calcn_l*contactPointPos_InBody_HC_s4_l) % GRF_9[1];
	GRM_l += GRM_9;

	Vec3 GRM_10 = (TR_GB_toes_l*contactPointPos_InBody_HC_s5_l) % GRF_10[1];
	GRM_l += GRM_10;

	Vec3 GRM_11 = (TR_GB_toes_l*contactPointPos_InBody_HC_s6_l) % GRF_11[1];
	GRM_l += GRM_11;
