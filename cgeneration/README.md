You can run the `generate_dll.ps1` Powershell script to obtain the dynamically linked library `<filename>.dll` corresponding to the external function F described in `OpenSim/External_Functions/<filename>.cpp'.
